$(function () {
  var portfolioItems = [
    ...
    {
      title: "NEXTWEB",
      imgSrc: "img/Personal/NEXTWEBCOVER.jpg",
      filter: "filter-3",
      lightboxImages: [
    ...
    {
      title: "Coffe Shop",
      imgSrc: "img/Personal/Coffe Shop 01.jpg",
      filter: "filter-3",
      lightboxImages: [
        "img/Personal/Coffe Shop 01.jpg",
        "img/Personal/Coffe Shop 02.png",
        "img/Personal/Coffe Order.png",
        "img3.png",
        "img4.jpg",
      ],
    },
    ...
    {
      title: "Watch Brand Official Web Site UI",
      imgSrc: "img/Personal/COVER LNG.jpg",
      filter: "filter-3",
      lightboxImages: [
        "img/Personal/DESIGN LNG.jpg",
       "img6.png",
       "img8.png",
       "img9.png",
      ],
    ...
    {
      title: "Child Care",
      imgSrc: "img/Personal/child care.jpg",
      filter: "filter-3",
      lightboxImages: [
        "img/Personal/DESIGN LNG.jpg",
       "img6.png",
    ...
    {
      title: "Dressy Project",
      imgSrc: "img/Personal/bannerfor ladies.jpg",
      filter: "filter-3",
      lightboxImages: [
        "img/Personal/seller page.png",
       "Home Page.png",
       "dashboard.jpg",
       "img9.png",
      ],
